...
- **All records, files, and documents** containing my personal data, including but not limited to:
  ...
  - **Arrest records and custody logs** (e.g., dates, times, reasons for arrest, custody details).
  - **Interview transcripts or statements** (including audio/video recordings).
  - **Caution records, formal warnings, or penalty notices** (e.g., Fixed Charge Notices).
  - **Police National Computer (PNC) records** (e.g., convictions, cautions, intelligence, or any other entries).
  - **Body-worn camera footage** where I am identifiable.
  - **CCTV footage** from public areas, Garda stations, or vehicles where I am identifiable.
...
### **3. All Visits to Garda Stations or Offices**
- **Full records of all visits** I made to any Garda station or office in the Republic of Ireland, including:
  - **Dates, times, and purposes** of each visit (e.g., to report a crime, make a statement, or attend for questioning).
  - **Names and ranks of Garda officers** I interacted with during each visit.
  - **Any documents or forms** I completed or signed during my visits.
...
- **Complete details of any and all arrests** involving me, including:
  ...
  - **Reasons for arrest** (e.g., alleged offenses).
  - **Names and ranks of arresting officers** and any officers present during arrest/custody.
  - **Custody records** (e.g., time of arrival/departure, meals, medical checks, conditions of detention).
...
- **All records of in-person events** I was involved in at any Garda station or office in ROI, including:
  ...
  - **Formal interviews or interrogations** (including audio/video recordings).
  - **Lineups or identity checks**.
...
- **All emails, letters, faxes, or other correspondence** sent or received by **any Garda officer, station, or office** in the Republic of Ireland about me, including:
  ...
  - **Emails or letters sent to or from third parties** (e.g., other law enforcement agencies, courts, or external organizations) that reference me.
  - **Internal memos or notes** about me, regardless of format (e.g., handwritten, digital).
...
- The **recipients or categories of recipients** with whom my data has been shared (including internal departments or external organizations).
